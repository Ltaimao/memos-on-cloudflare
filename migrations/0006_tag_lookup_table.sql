...
CREATE INDEX IF NOT EXISTS idx_memo_tag_tag ON memo_tag(tag);
CREATE INDEX IF NOT EXISTS idx_memo_tag_memo_id ON memo_tag(memo_id);
CREATE INDEX IF NOT EXISTS idx_memo_tag_creator_tag ON memo_tag(creator_id, tag);
...
CREATE INDEX IF NOT EXISTS idx_memo_is_comment ON memo(is_comment);
