...
CREATE INDEX IF NOT EXISTS idx_memo_yearON memo(year);
...
CREATE INDEX IF NOT EXISTS idx_memo_creator_yearON memo(creator_id, year);
...
-- 为用户级时间查询创建组合索引
CREATE INDEX IF NOT EXISTS idx_memo_creator_created_ts ON memo(creator_id, created_ts DESC);
